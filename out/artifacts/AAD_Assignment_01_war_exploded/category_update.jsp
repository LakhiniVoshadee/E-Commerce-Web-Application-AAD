...
<head>
  ...
  <title>Fashion Collection Update</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.css" rel="stylesheet">
  <style>
    body {
      background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)),
      url('https://img.freepik.com/free-photo/fashion-store-display_1150-2724.jpg');
...
<div class="container">
  <div class="update-container">
    ...
    <form action="category-update" method="post">
      ...
      <div class="mb-3">
        <label for="category_description" class="form-label">Collection Description</label>
        <textarea
                class="form-control"
